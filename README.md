...
## 💻 Software Setup
1. Install **Adafruit_MCP4725** library from Arduino IDE Library Manager.  
2. Connect the hardware as shown.  
3. Upload any `.ino` file from the `/firmware` folder.  
4. Observe voltage/waveform output on VOUT pin of MCP4725.
